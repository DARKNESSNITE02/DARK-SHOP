...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-violet-900/20 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div className="w-full max-w-md bg-zinc-950 border border-zinc-800 rounded-2xl p-8 relative z-10 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">DARK SHOP</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {!isLogin && (
            <>
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-zinc-900 border border-zinc-800 rounded-lg py-2.5 pl-10 pr-4 text-sm text-white focus:outline-none focus:border-violet-600 transition-colors" 
              ...
              <div className="space-y-1">
                <label className="text-xs text-zinc-400 font-medium">Idade</label>
                <div className="relative">
          ...
          <div className="space-y-1">
            <label className="text-xs text-zinc-400 font-medium">Senha (Sua Chave de Criptografia)</label>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-zinc-900 border border-zinc-800 rounded-lg py-2.5 pl-10 pr-10 text-sm text-white focus:outline-none focus:border-violet-600 transition-colors" 
                placeholder="••••••••" 
                required
                minLength={6}
              />
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full bg-violet-600 hover:bg-violet-700 disabled:opacity-50 text-white font-bold py-3 rounded-lg mt-6 transition-all transform active:scale-95 flex items-center justify-center gap-2"
          >
            {isLoading ? (
